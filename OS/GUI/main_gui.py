...
root = tk.Tk(); root.title("Sistema de OS"); root.geometry("500x650")
...
tk.Button(root, text="Novo Item OS", width=30, command=os_gui.novo_item_os).pack(pady=5)
...
tk.Button(root, text="Consultar Itens OS", width=30, command=os_gui.consultar_itens_os).pack(pady=5)
